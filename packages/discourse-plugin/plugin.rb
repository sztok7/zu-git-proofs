...
auth_provider custom_url: "https://zugitproof.chainsafe.dev?returnUrl=localhost:4202/auth/login", title: "Login With ZuPass", authenticator: OAuth2BasicAuthenticator.new
